object ProjectDependencies {
    ...
    const val playServicesMapsUtils = "com.google.maps.android:android-maps-utils:${Versions.playServicesMapsUtils}"

    const val barcodeScanning = "com.google.mlkit:barcode-scanning:${Versions.barcode}"
    const val smsRetrieve = "com.google.android.gms:play-services-auth-api-phone:${Versions.smsRetrieve}"
    ...
    const val expandableLayout = "net.cachapa.expandablelayout:expandablelayout:${Versions.expandableLayout}"
    ...
    const val firebaseMessagingVersion = "com.google.firebase:firebase-messaging-ktx:${Versions.firebaseMessaging}"
    ...
    const val libMaterialProgress = "com.pnikosis:materialish-progress:${Versions.libMaterialProgress}"
    const val smartRefreshLayout = "com.scwang.smartrefresh:SmartRefreshLayout:${Versions.smartRefreshLayout}"
    const val smartRefreshHeader = "com.scwang.smartrefresh:SmartRefreshHeader:${Versions.smartRefreshHeader}"
    ...
    const val chuckerLibNoOp = "com.github.chuckerteam.chucker:library-no-op:${Versions.chuckerLibNoOp}"
    ...
    const val mlkitFaceDetection = "com.google.android.gms:play-services-mlkit-face-detection:${Versions.mlkitFaceDetection}"
    const val mlkitTextRecognition = "com.google.android.gms:play-services-mlkit-text-recognition:${Versions.mlkitTextRecognition}"
    const val mlkitBarcodeScanning = "com.google.android.gms:play-services-mlkit-barcode-scanning:${Versions.mlkitBarcodeScanning}"
    ...
    const val playServiceVisionCommon = "com.google.android.gms:play-services-vision-common:${Versions.playServiceVisionCommon}"
    const val playServiceVision = "com.google.android.gms:play-services-vision:${Versions.playServiceVision}"
    const val rxBinding = "com.jakewharton.rxbinding4:rxbinding:${Versions.rxBinding}"
    const val viewPagerDotIndicator = "com.tbuonomo.andrui:viewpagerdotsindicator:${Versions.viewPagerDotIndicator}"
    const val pageTransformerHelper = "com.github.OCNYang:PageTransformerHelp:${Versions.pageTransformerHelper}"
    ...
    const val customQrGenerator = "com.github.alexzhirkevich:custom-qr-generator:${Versions.customQrGenerator}"
