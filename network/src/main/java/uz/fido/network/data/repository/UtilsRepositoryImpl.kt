...
import uz.fido.network.domain.datasource.repositories.IUtilsRepository
...
class UtilsRepositoryImpl @Inject constructor(private val utilsService: UtilsApiInterface) :
    ...
    override suspend fun getCurrencyRates(
        token: String,
        getCurrencyRatesRequest: GetCurrencyRatesRequest
    ...
    override suspend fun getNewsList(token: String, getNewsList: GetNewsRequest): Resource<NewsListResponse> =
        getResult {
    ...
    override suspend fun updateNewsStatus(
        token: String,
        updateNewsStatusRequest: UpdateNewsStatusRequest
    ...
    override suspend fun getRatingList(token: String, request: GetRatingsRequest): Resource<RatingsResponse> =
        getResult {
    ...
    override suspend fun sendCallUser(token: String, request: SendCallUserRequest): Resource<BaseResponse> =
        getResult {
    ...
    override suspend fun calcScore(token: String, request: CalcScoreRequest): Resource<BaseResponse> =
        getResult {
