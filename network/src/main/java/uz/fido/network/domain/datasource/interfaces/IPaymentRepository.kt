...
interface IPaymentRepository {
    ...
    ): Resource<CheckSmsForPaymentResponse>
    ...
    suspend fun getBankNameRequest(
        token: String, getBankNameRequest: GetBankNameRequest
    ): Resource<BankNameResponse>

    suspend fun oneTimeInfoRequest(
        token: String, oneTimeInfoRequest: OneTimeInfoRequest
    ): Resource<OneTimeInfoResponse>
    ...
    ): Resource<SwiftCommissionResponse>
    ...
    ): Resource<SwiftTransferListResponse>
}