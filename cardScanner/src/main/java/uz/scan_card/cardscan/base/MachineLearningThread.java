...
public class MachineLearningThread implements Runnable {
    ...
    private final LinkedList<RunArguments> queue = new LinkedList<>();
    ...
    private void runModel() {
        ...
        if (args.mIsOcr) {
            ...
            float x = 0.0f;
            Bitmap croppedBitmap = Bitmap.createBitmap(bm, 0, (int) y, (int) width,
                    (int) height);
    ...
    class BitmapPair {
        ...
        private final Bitmap fullScreen;
