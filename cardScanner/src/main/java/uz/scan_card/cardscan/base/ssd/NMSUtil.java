...
public class NMSUtil {
    public static float IOUOf(float[] currentBox, float[] nextBox) {
        ...
        area0Left[0] = nextBox[0];
        area0Left[1] = nextBox[1];
        area0Right[0] = nextBox[2];
        area0Right[1] = nextBox[3];

        area1Left[0] = currentBox[0];
        area1Left[1] = currentBox[1];
        area1Right[0] = currentBox[2];
        area1Right[1] = currentBox[3];
