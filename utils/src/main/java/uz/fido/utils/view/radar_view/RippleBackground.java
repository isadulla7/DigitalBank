package uz.fido.utils.view.radar_view;
...
public class RippleBackground extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        int rippleColor = typedArray.getColor(R.styleable.RippleBackground_rb_color, ContextCompat.getColor(context, R.color.rippleColor));
