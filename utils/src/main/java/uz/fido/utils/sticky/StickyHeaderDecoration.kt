...
class StickyHeaderDecoration(private val mListener: StickyHeaderInterface) : RecyclerView.ItemDecoration() {
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val headerPos = mListener.headerPositionForItem(topChildPosition)
    ...
    private fun getHeaderViewForItem(headerPosition: Int, parent: RecyclerView): View {
        val layoutResId = mListener.headerLayout(headerPosition)
    ...
    private fun fixLayoutSize(parent: ViewGroup, view: View) {
        ...
        view.layout(
            0,
            0,
            view.measuredWidth, mStickyHeaderHeight
        )
    }
}