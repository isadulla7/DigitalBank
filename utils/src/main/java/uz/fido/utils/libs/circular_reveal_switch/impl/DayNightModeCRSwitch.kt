package uz.fido.utils.libs.circular_reveal_switch.impl

import android.graphics.Bitmap
import android.view.View
import androidx.appcompat.app.AppCompatDelegate
import uz.fido.utils.libs.circular_reveal_switch.CRSwitchBuilder
import uz.fido.utils.libs.circular_reveal_switch.CircularRevealSwitch
import uz.fido.utils.libs.circular_reveal_switch.SwitchAnimation
import uz.fido.utils.libs.circular_reveal_switch.SwitchListener
...
open class DayNightModeCRSwitch(builder: Builder) :
    ...
    @JvmField
    protected var toNightMode = builder.toNightMode
...
//        toNightMode = !isNightMode
    ...
    open class Builder(view: View) : CRSwitchBuilder<Builder>(view) {
        ...
        open fun toNightMode(nightMode: Boolean) = apply {
            this.toNightMode = nightMode
        }
