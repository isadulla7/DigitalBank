package uz.fido.utils.libs.circular_reveal_switch.ext
...
import uz.fido.utils.libs.circular_reveal_switch.impl.DayNightModeCRSwitch
import uz.fido.utils.libs.circular_reveal_switch.impl.ThemeCRSwitch
...
fun View.setDayNightModeSwitcher(
    ...
    val switcher = DayNightModeCRSwitch.Builder(this).apply {
        ...
        this.toNightMode(toNightMode ?: false)
