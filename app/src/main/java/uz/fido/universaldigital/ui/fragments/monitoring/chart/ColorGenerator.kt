...
fun getPieChartColors(numPieSlices: Int): MutableList<Int> {
    val colors = arrayListOf(
        ...
        Color.parseColor("#F095BA"),
        Color.parseColor("#4BCBD3"),
        Color.parseColor("#7DD27C"),
        Color.parseColor("#F9C541"),
        Color.parseColor("#BE93F8"),
        Color.parseColor("#A5D05F"),
        Color.parseColor("#57B6ED")
    )
    return colors.toCollection(ArrayList())
}
