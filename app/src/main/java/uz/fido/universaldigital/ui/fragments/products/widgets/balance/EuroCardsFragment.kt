...
class EuroCardsFragment : BaseSimpleFragment<FragmentBalaceByCardBinding>(
    ...
    override fun onInit(savedInstanceState: Bundle?) {
        ...
        currencyCards = MainBalanceDialog.euroCards
        initTickerView()
        ...
        binding.switchMainBalance.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked) {
                Paper.book().write(Const.TOTAL_BALANCE_TYPE, 3)
    ...
    override fun onResume() {
        super.onResume()
        binding.switchMainBalance.isChecked = Paper.book().read(Const.TOTAL_BALANCE_TYPE, 0) == 3
    }
    ...
    private fun setTotalBalance() {
        ...
        binding.tvTotalBalance.text =
            Format.formatAmount(Format.convertFromTiynDivide(totalBalance.toString())) + " " + "EUR"
    }
}