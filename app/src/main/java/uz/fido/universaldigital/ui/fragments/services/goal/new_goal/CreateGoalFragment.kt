...
class CreateGoalFragment : BaseFragment<FragmentCreateGoalBinding, GoalViewModel>(
    ...
    private fun setEditText() {
        ...
        binding.edYear.setText(
            if (goalModel.fixed_duration != 0) "${goalModel.fixed_duration} ${
                getString(
                    uz.fido.utils.R.string.month
                )
    ...
    private fun week(day: Int): String {
        return when (day) {
    ...
    private fun editConfirm() {
        ...
        goto(
            R.id.confirmGoalFragment, bundleOf(
    ...
    private fun getTargetRequest() = SetTargetRequest(
        depType = "",
        depId = "",
        fund_object_value = "",
