package uz.fido.universaldigital.ui.fragments.services.deposit.list
...
import uz.fido.universaldigital.databinding.FragmentClientDepositListBinding
...
@AndroidEntryPoint
class ClientDepositListFragment :
    BaseFragment<FragmentClientDepositListBinding, MenuProductsViewModel>(
        FragmentClientDepositListBinding::inflate, MenuProductsViewModel::class.java
    ) {
    ...
    private fun initClientDepositsRv() {
        binding.rvClientDeposits.apply {
            ...
            homeDepositsAdapter =
                HomeDepositsAdapter(this@ClientDepositListFragment, ArrayList(), false)
