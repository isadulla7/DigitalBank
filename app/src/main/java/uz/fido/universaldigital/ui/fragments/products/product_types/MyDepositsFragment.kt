...
import uz.fido.universaldigital.databinding.FragmentMyDepositsBinding
...
@AndroidEntryPoint
class MyDepositsFragment :
    BaseFragment<FragmentMyDepositsBinding, MenuProductsViewModel>(
        FragmentMyDepositsBinding::inflate, MenuProductsViewModel::class.java
    ) {
