...
class DepositConstructorTimeDialog(
    ...
    private lateinit var binding: DepositConstructorTimeBottomSheetBinding
    ...
    override fun onCreateView(
        ...
        binding = DepositConstructorTimeBottomSheetBinding.inflate(inflater, container, false)
        if (title != null) {
            binding.tvTitle.text = title
            binding.tvTitle.visibility = View.VISIBLE
        }
        adapter = ConstructorTimeAdapter(baseInterface, list as ArrayList<AllServiceLists>, viewTag ?: "")
