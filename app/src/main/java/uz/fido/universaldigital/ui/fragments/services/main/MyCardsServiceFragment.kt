...
import uz.fido.universaldigital.databinding.FragmentMyCardsServiceBinding
...
@AndroidEntryPoint
class MyCardsServiceFragment : BaseSimpleFragment<FragmentMyCardsServiceBinding>(
    FragmentMyCardsServiceBinding::inflate
    ...
    private fun initCardsRv(cardLayoutManager: GridLayoutManager) {
        cardsAdapter = CardsListAdapter(this@MyCardsServiceFragment, cardLayoutManager)
    ...
    private fun refreshCards() {
        try {
            cardsAdapter = CardsListAdapter(this@MyCardsServiceFragment, getLayoutManager())
    ...
    override fun selectedCard(card: CardResponse) {
        cardOperationsDialog = CardOperationsDialog(card, this@MyCardsServiceFragment)
