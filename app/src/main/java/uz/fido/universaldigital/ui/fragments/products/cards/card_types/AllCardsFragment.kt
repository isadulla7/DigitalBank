...
@AndroidEntryPoint
class AllCardsFragment : BaseSimpleFragment<FragmentAllCardsBinding>(
...
//            ArrayList()
//        }
//        clientAllCardList = cardList
//        cardsAdapter?.submitList(clientAllCardList)
//        showEmptyView(clientAllCardList)
    }

    private fun initCardsRv(cardLayoutManager: GridLayoutManager) {
        cardsAdapter = CardsListAdapter(this@AllCardsFragment, cardLayoutManager)
    ...
    private fun refreshCards() {
        try {
            cardsAdapter = CardsListAdapter(this@AllCardsFragment, getLayoutManager())
    ...
    override fun selectedCard(card: CardResponse) {
        cardOperationsDialog = CardOperationsDialog(card, this@AllCardsFragment)
