...
class MonitoringAmountDialog(private val itemClickListener: (String, String) -> Unit) : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnContinue.setOnClickListener {
            dismiss()
            itemClickListener.invoke(binding.etAmountMin.text.toString(), binding.etMaxAmount.text.toString())
        }
    }
    ...
    private fun isCorrect(min: CharSequence, max: CharSequence): Boolean {
