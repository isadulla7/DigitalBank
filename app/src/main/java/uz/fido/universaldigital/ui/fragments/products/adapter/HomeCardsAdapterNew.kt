...
class HomeCardsAdapterNew(
    private val baseInterface: BaseInterface,
    private var list: ArrayList<CardResponse>
) : RecyclerView.Adapter<HomeCardsAdapterNew.ViewHolder>(), ItemTouchHelperAdapter {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            ItemHomeUserCardBinding.inflate(
    ...
    inner class ViewHolder(private val binding: ItemHomeUserCardBinding) :
    ...
    fun setList(card: ArrayList<CardResponse>) {
        list = card
