...
class ServiceAdapter(private val context: Context,
                     ...
                     private val baseInterface: BaseInterface):RecyclerView.Adapter<ServiceAdapter.VhService>() {
        ...
        fun onBind(template: Template) {
           binding.text.text=template.name
            ...
            binding.more.background=if(template.isCurrent){
                  context.getDrawable(R.drawable.ic_my_home_okay_check)
              }else context.getDrawable(R.drawable.ic_my_home_service)
